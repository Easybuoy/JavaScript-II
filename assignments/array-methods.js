...
let allCaps = [];
runners.map((runner) => allCaps.push(`${runner.first_name.toUpperCase()} ${runner.last_name}`));
console.log(allCaps); 
...
// Problem 2
//get shirt sizes to new array
let shirtSize = [];
runners.map((runner) => shirtSize.push(`${runner.shirt_size}`));
console.log(shirtSize); 

// Problem 3
//Get details about user by email
let emails = [];
emails = runners.filter((runner) => runner.email === 'sbaine1d@intel.com');
console.log(emails);